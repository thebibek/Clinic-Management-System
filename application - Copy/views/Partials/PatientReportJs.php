    ...
    app.controller('PatientReportAppCtrl', function ($scope, $http, $window, $filter) {
        ...
        $scope.getReport = function () {
            ...
            if (type == 1) {
                ...
                $http.post('<?php echo base_url("app/patient/report/month/wise/visit"); ?>', $Data, config).then(function (response) {
            ...
            if (type == 2) {
                ...
                $http.post('<?php echo base_url('app/patient/wise/monthly/collection'); ?>', $Data, config).then(function (response) {
                    $("#ReportPanel").removeClass('height2');
                    $("#ReportHtml").html(response.data);
                });
            }
            ...
            if (type == 3) {
                ...
                $http.post('<?php echo base_url('app/date/wise/patient/visit'); ?>', $Data, config).then(function (response) {
                    $("#ReportPanel").removeClass('height2');
                    $("#ReportHtml").html(response.data);
                });
