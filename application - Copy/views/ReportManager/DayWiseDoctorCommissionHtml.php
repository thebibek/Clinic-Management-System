...
<p style="text-align: center"><?php echo isset($date)? $date : 'XXXXX'; ?></p>
<table class="table report">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="3" class="text-right bdr-l-0"><strong>Total</strong></td>
            <td class="text-green"><strong><?php echo number_format($sumComm, 2, '.', ','); ?><strong></td>    
            <td class="bdr-r-0 text-danger"><strong><?php echo number_format($sumPayAmt, 2, '.', ','); ?><strong></td>    
