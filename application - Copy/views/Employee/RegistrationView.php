...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid" ng-app="EmployeeRegistrationApp" ng-controller="EmployeeRegistrationCtrl">
            <div class="card card shadow border-primary mt-3">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <p class="fs-5 m-0">Employee Registration</p>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-end">
                                            ...
                                            <a href="<?php echo base_url('app/employee/registration'); ?>" class="btn  btn-outline-dark fs-6 shadow rounded-0  btn-sm" ><img src="<?php echo base_url("assets/img/icons/close1.png"); ?>"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-md-12 text-end">
                                            <button class="btn btn-primary" ng-click="saveEmployee()" type="button"><span class="icon-save"></span> Save</button>
                                            <a class="btn btn-danger" href="<?php echo base_url('app/employee/registration'); ?>">Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <?php $this->load->view("Partials/EmployeeRegistrationJs"); ?>
    </body>
</html>