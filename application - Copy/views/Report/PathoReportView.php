...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid"  ng-app="PathologyReportApp" ng-controller="PathologyReportAppCtrl">
                                    ...
                                    <div class="card border-warning shadow">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select border-warning bg-light rounded-0" ng-model="ReportModel">
                                                    <option value="">Please select report</option>
                                                    <option value="1">Monthly completed pathology report</option>
                                                    <option value="2">Monthly pending pathology report </option>
                                                    <option value="3">Date wise completed report</option>
                                                    <option value="4">Date wise pending report</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label text-danger">Select Month</label>
                                                <select class="form-select border-warning bg-light rounded-0" ng-model="MonthModel">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control border-warning bg-light rounded-0" ng-model="DateModel"  id="ReportDate" readonly="" placeholder="Date">
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button class="btn btn-info border-primary rounded-0 btn-sm" ng-click="getReport()">Preview</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <?php $this->load->view("Partials/PathologyReportJs"); ?>
    </body>
</html>