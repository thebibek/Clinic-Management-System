<script>
    ...
    app.controller('TrialBalanceAppCtrl', function($scope, $http, $window, $filter) {
        var config = {
            headers: {
        ...
        function getTrialBalance() {
            ...
            $http.post('<?php echo base_url('app/provide/account/trial/balance'); ?>', $Data, config).then(function(response) {
