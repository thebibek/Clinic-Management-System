...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid" ng-app="ReceiptApp" ng-controller="ReceiptAppCtrl">
            <div class="card card shadow border-primary mt-3">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <p class="fs-5 m-0">Test Invoice</p>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url("app/dashboard"); ?>">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url("app/test"); ?>">Test</a></li>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Doctor Panel</h5>
                    ...
                    <div class="modal-body">
                        <div class="card border-warning shadow">
                            ...
                            <div class="panel-body pad-0">
                                <div class="scrollbar" id="style-7">
                                    <div class="force-overflow">
                                        <table class="table table-striped table-bordered border-warning no-margin doctor-list table-sm">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Doctor</th>
                                                ...
                                                if (isset($doctors)) {
                                                    if (!empty($doctors)) {
                                                        foreach ($doctors as $d) {
                                                            ?>  
                                                            <tr class="test-row" data-id="<?php echo $d['DoctorID']; ?>" data-commision="<?php echo $d['Commision']; ?>" data-name="<?php echo $d['Salutation'] . " " . $d['FirstName'] . " " . $d['LastName']; ?>" data-mobile="<?php echo $d['MobileNo']; ?>">
        ...
        <?php $this->load->view("Partials/ReceiptJs"); ?>
    </body>
</html>